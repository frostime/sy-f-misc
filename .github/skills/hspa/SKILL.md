---
skill: hspa
description: A way to develop UI for plugin by writing single html page in sy-f-misc. When user ask agent to develop UI using HSPA or "HTML Page", use this skill.
---
