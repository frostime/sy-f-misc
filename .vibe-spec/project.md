...
All the files below are listed under `.vibe-spec/knowledge/`,

| File | Content |
|------|---------|
| `solid-signal-ref.md` | Usage of `@frostime/solid-signal-ref`, read if need |
| `html-page.md` | How to use `html-page` function to write UI, read if asked to use html-page |
