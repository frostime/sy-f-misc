...
**Recent**:
- 2026-06-08T15:35+08:00 Fixed subtree operation viewport reset by preserving scroll during operation re-render; `pnpm run type-check` and `pnpm run build` passed.
